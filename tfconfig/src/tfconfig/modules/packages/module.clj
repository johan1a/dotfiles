...
(defn run
  ...
  (do
    ...
    (let [sudo-context (assoc context :sudo true)
      ...
      (link executable-context (<< "~(:modules-dir context)utils/files/local_scripts_common/s") (str (:home context) ".local/bin/s"))
      (link executable-context (<< "~(:modules-dir context)utils/files/local_scripts_common/new-local-script") (str (:home context) ".local/bin/new-local-script"))
      (link executable-context (<< "~(:modules-dir context)utils/files/local_scripts_common/edit-local-script") (str (:home context) ".local/bin/edit-local-script"))
      (link executable-context (<< "~(:modules-dir context)utils/files/local_scripts_common/list-local-scripts") (str (:home context) ".local/bin/list-local-scripts"))
      (directory context (str (:home context) ".config/fish/completions"))
      (link context (<< "~(:modules-dir context)utils/files/local_scripts_common/s_completions.fish") (str (:home context) ".config/fish/completions/s.fish"))
